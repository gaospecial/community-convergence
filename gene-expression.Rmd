...
if (save_figure_to_ppt) export::graph2ppt(file="figures.pptx",append=TRUE)
if (save_tiff) ggsave("figure S5.tiff",path="figures", compression = "lzw")
...
```{r gsea-dotplot, fig.asp=1.5, fig.width = 10, fig.cap="(ref:gsea-dotplot-figcap)"}
plot_grid(p1,p2,align = "v", ncol = 1,labels = "AUTO",rel_heights = c(1.5,1))
if (save_tiff) ggsave("figure 5.tiff",path="figures", compression = "lzw")
```
